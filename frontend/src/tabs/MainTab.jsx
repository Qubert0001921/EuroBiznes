...
function MainTab() {
    ...
    return (
        <>
            <label>Where: </label>
            <select id='select-people' value={personId} onChange={element => setPersonId(element.value)}>
                <option value="1">example1</option>
                <option value="2">example2</option>
            </select>
            <label>How much money: </label>
            <input id='inp-money-amount' type='text' value={moneyAmount} onChange={element => setMoneyAmount(element.value)} />
